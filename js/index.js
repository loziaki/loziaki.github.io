    ...
    data: function () {
        return {
            question: [{
                ...
                title: '<p>代码的静态检查</p><p class="sup">在不跑程序下的对代码进行错误排查</p>',
                rm: '编译器的安全检查很重要，不能进行静态检查的代码通常是不可接受的。',
                wm: '代码应该短小精悍，静态检查工具可能会让代码变得又臭又长。'
            }, {
                title: '<p>程序中数据的格式定义</p><p class="sup">譬如函数中传递的参数、数据类</p>',
                ...
                title: '<p>急上线但有安全隐患的系统</p><p class="sup">运营和产品经理来催了~</p>',
